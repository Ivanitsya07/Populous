...
import { P, Small } from '../../../components/styled-components/Typography/headers';
          ...
          <Col xs={'12'} className="p-0 m-t-20">
            <Collapse isOpen={this.state.collapse} className="p-30" style={{'background': '#F5F7FA'}}>
              <Container>
                <Row>
                  <Col xs={'12'}>
                    <P opacity={0.8}>You must have an authentication app installed on your phone or tablet. This app generates access codes for your Populous account. We will ask you to enter these codes to confirm some important actions for your account, like login or changing account settings.</P>
                    <P opacity={0.8}>If you lost your authentication app or device, you can reset 2FA via email, like your password.</P>
                    <P opacity={0.8}>Authentication apps we can recommend are:</P>
                  </Col>
                  <Col xs={'12'} md={'4'}>
                    <img className="pull-left" src="./img/app/img-ga-logo@2x.png" width={48} alt="Google Authenticator" />
                    <div className="p-l-10 pull-left">
                      <P opacity={0.8} className="m-b-0">
                        Google Authenticator
                      </P>
                      <Small opacity={0.6} inline>Download:</Small>
