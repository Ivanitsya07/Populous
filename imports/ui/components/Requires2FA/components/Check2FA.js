...
const Check2FA = ({ show, verify, onCancel }) => {
  if (!show) {
    return null;
  }
        ...
        <div className="modal-content">
          ...
          >
            <div className="modal-header">
              ...
              <button type="button" className="close" style={{ cursor: 'pointer' }} aria-label="Close" onClick={onCancel}>
            ...
            <div className="modal-body">
              <Row>
                <Col sm={9} xs={8}>
                  <p>Please enter the 6-digit code generated by the authentication app on your device.</p>
            ...
            <div className="modal-footer justify-content-center">
              <Row>
                ...
                <Col sm={12} xs={12} className="text-center m-t-10">
                  <a href="">I'm not able to log in with 2FA</a>
                </Col>
              </Row>
            </div>
          </form>
